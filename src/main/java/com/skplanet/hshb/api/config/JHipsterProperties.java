...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hshbapi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hshbapi API";

        private String description = "hshbapi API documentation";
